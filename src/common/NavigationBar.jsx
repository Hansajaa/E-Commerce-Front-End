...
function NavigationBar() {
  ...
  return (
    <div>
      <nav class="bg-white border-gray-200 dark:bg-[#15616D] rounded-full w-3/4 ml-auto mt-3 mr-3">
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-1.5">
          ...
          <div
            class="items-end justify-end hidden w-full md:flex md:w-auto md:order-1 ml-auto mr-5"
            id="navbar-user"
          >
            <ul class="flex flex-col font-medium p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-[#15616D] dark:border-gray-700">
              <li>
                <a
                  href="#"
